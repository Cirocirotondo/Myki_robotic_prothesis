function [sensors_rototrasl] = disturb_rotz(sensors,m,ff, nb_CK)
...
% iniziale.
    ...
    if m == 1
        sensors_rototrasl = rotz(10/nb_CK*ff) * sensors_rototrasl;
    elseif m == 2
        sensors_rototrasl = rotz(10 - 10/nb_CK*ff) * sensors_rototrasl;
    elseif m == 3
        sensors_rototrasl = rotz(-10/nb_CK*ff) * sensors_rototrasl;
    elseif m == 4
        sensors_rototrasl = rotz(-10 + 10/nb_CK*ff) * sensors_rototrasl;
