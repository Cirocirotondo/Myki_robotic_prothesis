%% Derby Olbert Model for Axially Magnetized Permanent Magnet
 ...
 %
 % Outputs:
 %    1) Brho   : azimuthal component of the magnetic field       [number]
...
function [Brho,Bz] = AxialCylModelDerby3(D,L,M,MagPos,Point)
...
Bz  = B0*R/(R+rho)*(betaP*GeneralizedEllipke(kP,gamma^2,1,gamma,1e-7) - ...
                    betaM*GeneralizedEllipke(kM,gamma^2,1,gamma,1e-7));
end
