...
%plot_mags plots magnets in space
  nMag = size(x,1);
  vect_mult = 0.005;  % scale vectors dimensions
  xVis = vec2mat(x, DoFs);
  ...
  quiver3(xVis(1:nMag,1), xVis(1:nMag,2), xVis(1:nMag,3), Rx_vis, Ry_vis, Rz_vis, north_color, 'AutoScale','off')
  quiver3(xVis(1:nMag,1), xVis(1:nMag,2), xVis(1:nMag,3), -Rx_vis, -Ry_vis, -Rz_vis, south_color, 'AutoScale','off')
end
