...
Brho = B0*(alphaP.*ParallelBulirsch(kP,uni,uni,-uni,1e-9) - ...
                    alphaM.*ParallelBulirsch(kM,uni,uni,-uni,1e-9));
               
Bz   = B0*R./(R+rho).*(betaP.*ParallelBulirsch(kP,gamma.*gamma,uni,gamma,1e-9) - ...
                    betaM.*ParallelBulirsch(kM,gamma.*gamma,uni,gamma,1e-9));