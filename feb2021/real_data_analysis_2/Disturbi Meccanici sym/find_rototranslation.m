function [rot_trasl] = find_rototranslation(x6Mod, trajectories,direction_mean, nMag,errMax, rot_trasl_precedente)
    ...
    fun = @(rototranslation) cost_function_vect(rototranslation, x6Mod, trajectories,direction_mean, nMag, errMax);
