%VERSION 4: non viene ancora corretto il riordinamento dei magneti (non
%esiste x6CorrectedRiord)
...
if everyone_in_trajectory == 0
    ...
    costo(k) = cost_function(rototranslation{k}, x6Corrected{k}, trajectories, nMag, errMax);   
